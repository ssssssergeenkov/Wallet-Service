...
/**
 * The TransactionsDaoImpl class is responsible for interacting with the database
 * and performing CRUD operations on the "transactions" table.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class TransactionsDaoImpl implements TransactionsDao<String, Transaction> {
    public static final TransactionsDaoImpl INSTANCE = new TransactionsDaoImpl();

    /**
     * Get the singleton instance of TransactionsDaoImpl.
     *
     * @return The instance of TransactionsDaoImpl.
     */
